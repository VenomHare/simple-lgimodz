                ...
                <section id="tiers" className="mt-[10dvh]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                        {EvolutionTiers.map((tier, index) => (
                            <Card
                                key={index}
                                className={`relative ${tier.popular ? "ring-2 ring-primary scale-105" : ""} hover:scale-105 transition-transform duration-200`}
                            >
                                {tier.popular && (
                ...
                <section>
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground text-lg">
                            15 meticulously crafted wrestling venues with authentic atmosphere
                        </p>
                    </div>
