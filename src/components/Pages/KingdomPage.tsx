...
import { Credits, KingdomMetadata, LimitedMetadata } from "@/configs/metadata"
...
const screenshots = [
    "https://lgimodz.vercel.app/patches/limited/screenshots/1.webp",
    "https://lgimodz.vercel.app/patches/limited/screenshots/2.webp",
    "https://lgimodz.vercel.app/patches/limited/screenshots/3.webp",
    "https://lgimodz.vercel.app/patches/limited/screenshots/4.webp",
    "https://lgimodz.vercel.app/patches/limited/screenshots/5.webp",
    "https://lgimodz.vercel.app/patches/limited/screenshots/5.webp",
    "https://lgimodz.vercel.app/patches/limited/screenshots/5.webp",
]
            ...
            <main className="container mx-auto px-4 py-8 space-y-12">
                ...
                <section className="text-center space-y-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-4 text-sm">
                        <div className="flex items-center gap-2 bg-card px-4 py-2 rounded-lg">
                            ...
                            <span>{KingdomMetadata.wrestlers_count} Wrestlers</span>
                        </div>
                        <div className="flex items-center gap-2 bg-card px-4 py-2 rounded-lg">
                            <MapPin className="w-4 h-4 text-primary" />
                            <span>{KingdomArenas.length} Arenas</span>
                        </div>
                        <div className="flex items-center gap-2 bg-card px-4 py-2 rounded-lg">
                ...
                <section>
                    <div className="w-full flex flex-col items-center justify-center gap-3">
                        <div className="space-y-1">
                            <div className="text-3xl font-bold">${KingdomPricing.priceUSD}</div>
                            <div className="text-lg text-muted-foreground">₹{KingdomPricing.priceINR}</div>
                        </div>
                        <Button
                        ...
                        >
                            Purchase {KingdomMetadata.label}
                        </Button>
                    </div>
                </section>
                {/* Wrestlers Section */}
                <section>
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground text-lg">{KingdomMetadata.wrestlers_count} legendary wrestlers from different eras of WWE history</p>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
                        {KingdomRoster.slice(0, 12).map((wrestler) => (
                        ...
                        <Dialog open={showAllWrestlers} onOpenChange={setShowAllWrestlers}>
                            <DialogTrigger asChild>
                                <Button variant="outline" size="lg">
                                    ...
                                    View All {KingdomArenas.length} Wrestlers
                                </Button>
                            </DialogTrigger>
                ...
                <section>
                    <div className="text-center mb-8">
                        ...
                        <p className="text-muted-foreground text-lg">
                            {KingdomArenas.length} meticulously crafted wrestling venues with authentic atmosphere
                        </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {KingdomArenas.slice(0, 6).map((arena) => (
                        ...
                        <Dialog open={showAllArenas} onOpenChange={setShowAllArenas}>
                            <DialogTrigger asChild>
                                <Button variant="outline" size="lg">
                                    ...
                                    View All {KingdomArenas.length} Arenas
                                </Button>
                            </DialogTrigger>
                            <DialogContent className="max-w-6xl max-h-[80vh] overflow-y-auto">
                                <DialogHeader>
