        ...
        <div className="w-[100svw] min-h-[10svh] border-t-2 border-primary flex justify-center mt-10">
            <div className="w-[85svw] lg:w-[75svw] xl:w-[60svw]  h-full flex flex-col md:flex-row py-10 gap-10">
                <div className="w-full h-full flex gap-4 px-4">
                    <div className="w-10 h-10 md:w-15 md:h-15 rounded-full bg-gray-500"></div>
                    <div className="flex flex-col gap-4">
                        <h4 className="font-medium text-lg font-playwrite">Homemade Soaps</h4>
                        <h5 className="font-light text-sm font-schibsted">"Because Your Skin Deserves the Best"</h5>
                    </div>
                </div>
                <div className="w-full flex flex-col items-end gap-4">
                    <div className="w-full flex flex-col items-center">
                        <div className="text-2xl font-semibold font-schibsted">Sarika Kadam</div>
                    ...
                    <div className="w-full flex justify-center gap-4">
                        <a href="https://wa.me/+919869950563">
                            <Button
                                size={"icon"}
                                variant={"outline"}
